...
const static uint64_t system_account_name    = N(gxc);
const static uint64_t null_account_name      = N(gxc.null);
const static uint64_t producers_account_name = N(gxc.prods);
...
const static uint64_t eosio_auth_scope       = N(gxc.auth);
const static uint64_t eosio_all_scope        = N(gxc.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(gxc.any);
const static uint64_t eosio_code_name = N(gxc.code);

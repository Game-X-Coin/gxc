...
function resources() {
    echo "${COLOR_CYAN}GameXCoin website:${COLOR_NC} https://www.gamexcoin.io"
    echo "${COLOR_CYAN}GameXCoin Telegram channel (for Global Users):${COLOR_NC} https://t.me/GXC_EN"
    echo "${COLOR_CYAN}GameXCoin Telegram channel (for Korean Users):${COLOR_NC} https://t.me/GXC_KR"
}
